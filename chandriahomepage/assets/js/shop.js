...
$(document).ready(function () {
    ...
    async function displayProducts(user, page = 1, searchTerm = '', selectedCategory = '', sortBy = '') {
        currentUser = user;
    ...
    function generatePagination(currentPage, totalPages) {
        ...
        $(".pagination-btn").on("click", function (e) {
            ...
            displayProducts(currentUser, selectedPage, searchTerm, selectedCategory, sortBy);
        });
    }
    ...
    $("#product-search").on("input", function() {
        ...
        searchTimeout = setTimeout(() => {
            const selectedCategory = currentCategory === 'all' ? '' : currentCategory;
            const sortBy = currentSort === 'default' ? '' : currentSort;
            displayProducts(currentUser, 1, searchTerm, selectedCategory, sortBy);
        }, 300);
    });
    ...
    $("#clear-search").on("click", function() {
        ...
        const selectedCategory = currentCategory === 'all' ? '' : currentCategory;
        const sortBy = currentSort === 'default' ? '' : currentSort;
        displayProducts(currentUser, 1, "", selectedCategory, sortBy);
    });
    ...
    // Category filter option selection
    $(document).on("click", ".filter-option", function(e) {
        e.stopPropagation();
        const category = $(this).data("category");
        const categoryText = $(this).find("span").text();
        ...
        // Update button text
        $("#category-filter-btn .filter-text").text(categoryText);
        
        // Close dropdown
        $(".filter-dropdown").removeClass("active");
        
        // Update current category and trigger search
