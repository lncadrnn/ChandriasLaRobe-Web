    ...
    try {
        ...
        if (typeof firebase !== "undefined" && firebase.firestore) {
            ...
            firebase
                ...
                .then(() => {
                    console.log(
                        "✅ Firebase: Appointment status updated to pending"
                    );

                    // Show success notification
                    if (typeof notyf !== "undefined") {
                        notyf.success(
                            "Appointment confirmation has been undone"
                        );
                    ...
                    if (parentModalId) {
                        ...
                        if (
                            typeof restoreBackgroundInteraction === "function"
                        ) {
                    ...
                    if (typeof renderAppointments === "function") {
                        console.log(
                            "Refreshing appointments list after undo confirmation..."
                        );
                        renderAppointments();
                    } else {
                ...
                .catch(error => {
                    ...
                    if (typeof notyf !== "undefined") {
                        notyf.error(
                            "Failed to undo confirmation. Please try again."
                        );
            ...
            console.log(
                "Mock implementation: Appointment status changed to pending"
            );
            ...
            if (typeof renderAppointments === "function") {
                console.log(
                    "Refreshing appointments list after mock undo confirmation..."
                );
                renderAppointments();
            } else {
                // Fallback to the icon update function if renderAppointments is not available
...
$(document).on(
    "click",
    "#undo-confirmation-modal .cancel-action",
    function (e) {
        e.preventDefault();
        e.stopPropagation();

        console.log(
            "🔄 Undo confirmation cancelled, restoring appointment modal"
        );
        ...
        if (parentModalId) {
            ...
            setTimeout(() => {
                ...
                console.log(
                    "✅ Appointment modal restored after undo cancellation"
                );
            }, 50);
        }
    }
...
$(document).on(
    "click",
    "#undo-confirmation-modal .close-confirmation-modal",
    function (e) {
        e.preventDefault();
        e.stopPropagation();

        console.log(
            "🔄 Undo confirmation modal closed via X button, restoring appointment modal"
        );
        ...
        if (parentModalId) {
            ...
            setTimeout(() => {
                ...
                console.log(
                    "✅ Appointment modal restored after undo modal close"
                );
            }, 50);
        }
    }
...
$(document).on(
    "click",
    "#undo-cancellation-modal .close-confirmation-modal",
    function (e) {
        e.preventDefault();
        e.stopPropagation();

        console.log(
            "🔄 Undo cancellation modal closed via X button, restoring appointment modal"
        );
        ...
        if (parentModalId) {
            ...
            setTimeout(() => {
                ...
                console.log(
                    "✅ Appointment modal restored after undo cancellation modal close"
                );
            }, 50);
        }
    }
...
$(document).on(
    "click",
    "#undo-cancellation-modal .cancel-action",
    function (e) {
        e.preventDefault();
        e.stopPropagation();

        console.log(
            "🔄 Undo cancellation cancelled, restoring appointment modal"
        );
        ...
        if (parentModalId) {
            ...
            setTimeout(() => {
                ...
                console.log(
                    "✅ Appointment modal restored after undo cancellation cancelled"
                );
            }, 50);
        }
    }
...
$(document).on("click", ".modal .modal-backdrop", function (e) {
    if (e.target === this) {
        ...
        if (modalId === "undo-confirmation-modal") {
            console.log(
                "🔄 Undo confirmation modal backdrop clicked, restoring appointment modal"
            );
            ...
            if (parentModalId) {
                ...
                setTimeout(() => {
                    ...
                    console.log(
                        "✅ Appointment modal restored after backdrop click"
                    );
                }, 50);
            }
        } else if (modalId === "undo-cancellation-modal") {
            console.log(
                "🔄 Undo cancellation modal backdrop clicked, restoring appointment modal"
            );
            ...
            if (parentModalId) {
                ...
                setTimeout(() => {
                    ...
                    console.log(
                        "✅ Appointment modal restored after undo cancellation backdrop click"
                    );
                }, 50);
            }
        } else {
...
$(document).on("keydown", function (e) {
    if (e.key === "Escape") {
        ...
        if (visibleModal.length > 0) {
            ...
            if (modalId === "undo-confirmation-modal") {
                console.log(
                    "🔄 Undo confirmation modal closed via ESC, restoring appointment modal"
                );
                ...
                if (parentModalId) {
                    ...
                    setTimeout(() => {
                        ...
                        // Re-enable background interaction prevention
                        if (
                            typeof preventBackgroundInteraction === "function"
                        ) {
                            preventBackgroundInteraction();
                        }

                        console.log(
                            "✅ Appointment modal restored after ESC key"
                        );
                    }, 50);
                }
            } else if (modalId === "undo-cancellation-modal") {
                console.log(
                    "🔄 Undo cancellation modal closed via ESC, restoring appointment modal"
                );
                ...
                if (parentModalId) {
                    ...
                    setTimeout(() => {
                        ...
                        console.log(
                            "✅ Appointment modal restored after undo cancellation ESC key"
                        );
                    }, 50);
                }
            } else {
...
function closeModal(modalId) {
    ...
    if (modalId === "appointment-modal") {
        ...
        console.log(
            "🔄 Appointment modal fully reset including pointer-events"
        );
...
function updateAppointmentStatusIcon(appointmentId, status) {
    console.log(
        `🔄 Updating status icon for appointment ${appointmentId} to ${status}`
    );
    ...
    console.warn(
        "⚠️ renderAppointments function not found, falling back to manual update"
    );
    ...
    appointments.forEach(item => {
        ...
        if (
            viewButton &&
            viewButton.getAttribute("data-id") === appointmentId
        ) {
            isMatch = true;
        }
        ...
        if (isMatch) {
            ...
            if (!iconElement) {
                ...
                if (appointmentText && appointmentText.firstChild) {
                    appointmentText.insertBefore(
                        iconElement,
                        appointmentText.firstChild
                    );
    ...
    if (!found) {
        console.warn(
            "⚠️ Could not find appointment item to update icon for ID:",
            appointmentId
        );
    }
}
...
$(document).ready(function () {
    ...
    $(".close-modal, .close-rental-modal, .close-confirmation-modal").each(
        function () {
            $(this)
                .off("click")
                .on("click", function (e) {
...
$(document).on(
    "click",
    ".close-modal, .close-rental-modal, .close-confirmation-modal",
    function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    try {
        ...
        if (typeof firebase !== "undefined" && firebase.firestore) {
            ...
            firebase
                ...
                .then(() => {
                    console.log("Appointment has been confirmed");
                    ...
                    if (typeof window.renderAppointments === "function") {
                        console.log(
                            "Refreshing appointments list after confirmation..."
                        );
                        window.renderAppointments();
                    } else {
                        console.warn(
                            "renderAppointments function not found globally"
                        );
                        // Fallback to the icon update function if renderAppointments is not available
                ...
                .catch(error => {
                    ...
                    notyf.error("Error confirming appointment");
                });
        } else {
            // Demo/mock implementation when Firebase is not available
            console.log(
                "Mock implementation: Appointment status changed to confirmed"
            );
            ...
            if (typeof renderAppointments === "function") {
                console.log(
                    "Refreshing appointments list after mock confirmation..."
                );
                renderAppointments();
            } else {
                // Fallback to the icon update function if renderAppointments is not available
...
$(document).ready(function () {
    ...
    $(document).on("click", ".appointment-view-details", function (e) {
        ...
        const appointmentText = appointmentItem
            .find(".appointment-text")
            .text();
        ...
        const appointmentId =
            appointmentItem.data("id") || `appointment-${Date.now()}`;
        ...
        const detailsHTML = `
            ...
            <div class="appointment-detail-item">
                ...
                <span class="detail-value status-${status}">${
        ...
        if (typeof firebase !== "undefined" && firebase.firestore) {
            ...
            firebase
                ...
                .then(() => {
                    ...
                    if (typeof renderAppointments === "function") {
                        console.log(
                            "Refreshing appointments list after cancel..."
                        );
                        renderAppointments();
                    } else {
                        // Fallback to the icon update function if renderAppointments is not available
            ...
            // Demo/mock implementation when Firebase is not available
            console.log(
                "Mock implementation: Appointment status changed to cancelled"
            );
            console.log("Appointment has been cancelled");
            // Refresh the appointments list to show the updated status
            if (typeof renderAppointments === "function") {
                console.log(
                    "Refreshing appointments list after mock cancel..."
                );
                renderAppointments();
            } else {
                // Fallback to the icon update function if renderAppointments is not available
...
$(document).on("click", ".undo-cancellation", function (e) {
    ...
    console.log(
        "🔄 Undo cancellation modal shown for appointment:",
        appointmentId
    );
});

// APPOINTMENT status from cancelled to confirmed
    ...
    try {
        ...
        if (typeof firebase !== "undefined" && firebase.firestore) {
            ...
            firebase
                ...
                .then(() => {
                    console.log(
                        "✅ Firebase: Appointment status updated from cancelled to confirmed"
                    );
                    ...
                    if (appointmentModal) {
                        ...
                        console.log(
                            "🔄 Modal state updated to confirmed from cancelled"
                        );
                    }
                ...
                .catch(error => {
                    console.error(
                        "❌ Firebase: Error updating appointment status from cancelled to confirmed:",
                        error
                    );

                    // Re-open parent modal if there was an error
                    const parentModalId = $("#undo-cancellation-modal").data(
                        "parentModal"
                    );
                    if (parentModalId) {
                        setTimeout(() => {
            ...
            console.log(
                "Mock implementation: Appointment status changed from cancelled to confirmed"
            );
